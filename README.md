...
* [💩 Escape From Callback Mountain 🚀](https://github.com/justsml/escape-from-callback-mountain) - Modern, low-jargon project showcasing my adaptable 'Functional Promises' pattern, by @justsml.
